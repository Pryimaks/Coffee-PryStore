        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CofCateg = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Basket", x => x.CartItemId);
                    table.ForeignKey(
                        name: "FK_Basket_Table_CofId",
                        column: x => x.CofId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Table_CofId",
                        column: x => x.CofId,
                        principalTable: "Table",
                        principalColumn: "CofId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Basket_CofId",
                table: "Basket",
                column: "CofId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_CofId",
                table: "OrderItems",
                column: "CofId");
